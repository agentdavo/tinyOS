...
/**
 * @file hal_arm64_irq.cpp
 * @brief arm64 IRQ dispatch (GIC) and the arm64 halves of the FP self-test.
 *        Split out of hal.cpp so hal.cpp can be linked on both arches.
 */
