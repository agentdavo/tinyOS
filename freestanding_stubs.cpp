...
// instructions, which are part of ARMv8.0-A. Compiled out on rv64 — the
// riscv64 ISA ships AMO primitives natively so GCC emits direct ops and
// the `__aarch64_*` helpers are never referenced.
